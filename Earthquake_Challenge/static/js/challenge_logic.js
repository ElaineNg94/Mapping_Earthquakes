...
// create third tile layer for the map. (deliverable 3 question 1)
...
let baseMaps = {
  ...
  "Dark": darkMap   //<--(deliverable 3)
};

// 1. Add a 2nd layer group for the tectonic plate data. (13.6.4)
let allEarthquakes = new L.LayerGroup();
let tectonicPlates = new L.LayerGroup();
let majorEQ = new L.LayerGroup(); //<--deliverable 2

// 2. Add a reference to the tectonic plates group to the overlays object. (13.6.4)
let overlays = {
...
// Looping through our intervals to generate a label with a colored square for each interval.???
  ...
  // 3. Use d3.json to make a call to get our Tectonic Plate geoJSON data. {deliverable 1) (13.5.5, 13.6.1, 13.6.2,)
